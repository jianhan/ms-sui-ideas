...
type Story struct {
	...
	Title string `protobuf:"bytes,2,opt,name=title" json:"title,omitempty" bson:"title" valid:"required~Title is required" conform:"trim" bson:"title" valid:"required~Title is required" conform:"trim" bson:"title" valid:"required~Title is required" conform:"trim" bson:"title" valid:"required~Title is required" conform:"trim" bson:"title" valid:"required~Title is required" conform:"trim"`
	// @inject_tag: bson:"pirority" valid:"required~Pirority is required"
	Pirority go_micro_srv_ideas.Pirority `protobuf:"varint,3,opt,name=pirority,enum=go.micro.srv.ideas.Pirority" json:"pirority,omitempty" bson:"pirority" valid:"required~Pirority is required" bson:"pirority" valid:"required~Pirority is required" bson:"pirority" valid:"required~Pirority is required" bson:"pirority" valid:"required~Pirority is required" bson:"pirority" valid:"required~Pirority is required"`
	// @inject_tag: bson:"role" valid:"required~Who is required" conform:"trim"
	Who string `protobuf:"bytes,4,opt,name=who" json:"who,omitempty" bson:"role" valid:"required~Who is required" conform:"trim" bson:"role" valid:"required~Who is required" conform:"trim" bson:"role" valid:"required~Who is required" conform:"trim" bson:"role" valid:"required~Who is required" conform:"trim" bson:"role" valid:"required~Who is required" conform:"trim"`
	...
	Goal string `protobuf:"bytes,6,opt,name=goal" json:"goal,omitempty" bson:"goal" valid:"required~Goal is required" conform:"trim" bson:"goal" valid:"required~Goal is required" conform:"trim" bson:"goal" valid:"required~Goal is required" conform:"trim" bson:"goal" valid:"required~Goal is required" conform:"trim" bson:"goal" valid:"required~Goal is required" conform:"trim"`
	// @inject_tag: bson:"order"
	Order uint64 `protobuf:"varint,7,opt,name=order" json:"order,omitempty" bson:"order" bson:"order" bson:"order" bson:"order" bson:"order"`
	// @inject_tag: bson:"created_at"
	CreatedAt *google_protobuf.Timestamp `protobuf:"bytes,8,opt,name=created_at,json=createdAt" json:"created_at,omitempty" bson:"created_at" bson:"created_at" bson:"created_at" bson:"created_at" bson:"created_at"`
	// @inject_tag: bson:"updated_at"
	UpdatedAt *google_protobuf.Timestamp `protobuf:"bytes,9,opt,name=updated_at,json=updatedAt" json:"updated_at,omitempty" bson:"updated_at" bson:"updated_at" bson:"updated_at" bson:"updated_at" bson:"updated_at"`
}
