...
type Idea struct {
	...
	MinAge uint32 `protobuf:"varint,7,opt,name=min_age,json=minAge" json:"min_age,omitempty" bson:"min_age"`
	// @inject_tag: bson:"max_age"
	MaxAge uint32 `protobuf:"varint,8,opt,name=max_age,json=maxAge" json:"max_age,omitempty" bson:"max_age"`
